...
<p align="center">
  ...
  <a href="#-безопасность-и-бэкапы"><b>Безопасность</b></a> •
  <a href="#-темы-оформления"><b>Темы</b></a> •
...
|:---:|:---:|
| *(Скриншот каталога игр)* | *(Скриншот карточки с пресетами)* |

| Тема «Киберпанк 2077» | Тема «Рубин» / «Аврора» |
|:---:|:---:|
| *(Скриншот темы Киберпанк)* | *(Скриншот темы Рубин)* |

</div>

> 💡 *Скриншоты можно добавить в папку `docs/screenshots/` репозитория.*
...
Разработано с ❤️ командой **GSett** для всех геймеров.  
*Если программа помогла вам повысить FPS — поставьте ⭐️ звёздочку репозиторию!*
